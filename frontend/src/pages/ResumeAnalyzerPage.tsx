    ...
    <div className="max-w-7xl mx-auto px-4 py-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-8 space-y-6">
          {/* Header */}
          <div className="mb-2">
            <h1 className="text-3xl font-black text-slate-800 tracking-tight">Upload Resume</h1>
          </div>
              ...
              {activeQueue.length > 0 ? (
                <div className="w-full max-w-md space-y-8 animate-in fade-in zoom-in-95 duration-500">
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-black text-slate-800 tracking-tight">AI Scanning in Progress...</h3>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between px-1">
                      ...
                      <span className="text-sm font-black text-violet-600">{Math.round(averageProgress)}%</span>
                    </div>
                    ...
                    <div className="flex justify-center gap-2 pt-2">
                       <span className="px-3 py-1 rounded-lg bg-indigo-50 text-[9px] font-black text-indigo-500 uppercase tracking-tight">Extracting Skills</span>
                       <span className="px-3 py-1 rounded-lg bg-emerald-50 text-[9px] font-black text-emerald-500 uppercase tracking-tight">Mapping Entities</span>
                    </div>
                  </div>
                </div>
              ) : (
                <>
                  ...
                  <button
                    className="mt-8 rounded-2xl px-10 py-3 text-sm font-black text-white shadow-lg shadow-violet-200 transition-all bg-gradient-to-r from-violet-600 to-violet-500 hover:from-violet-700 hover:to-violet-600 active:scale-95 uppercase tracking-wider"
                    onClick={(e) => {
                      e.stopPropagation()
          ...
          {(activeQueue.length > 0 || processedCandidates.length > 0) && (
            <div className="space-y-6 animate-in fade-in slide-in-from-top-4 duration-500">
              ...
              {activeQueue.length > 0 && (
                <div className="space-y-3">
                  <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] px-2">Active Scanning</h3>
              ...
              {processedCandidates.length > 0 && (
                <div className="space-y-3">
                  <div className="flex items-center justify-between px-2">
                    <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Successfully Processed</h3>
        ...
        <div className="lg:col-span-4 space-y-6 lg:sticky lg:top-8">
          ...
          <div className="bg-white p-5 rounded-3xl border border-slate-100 shadow-sm">
            <h3 className="text-xs font-black text-slate-400 uppercase tracking-[0.2em] mb-4">Upload Mode</h3>
            <div className="flex flex-col gap-2">
              <button
                onClick={() => setActiveTab('single')}
                className={`flex items-center justify-between w-full px-5 py-3.5 rounded-2xl text-sm font-bold transition-all border ${
                  activeTab === 'single'
