...
import { Search, RefreshCw, ChevronDown, ChevronUp, User, Briefcase, Calendar } from "lucide-react";
...
export default function SubmissionReviewPage() {
  ...
  const { submissions, pagination, isLoading, fetchPendingSubmissions, reviewSubmission, clearError } = useSubmissionReviewStore();
