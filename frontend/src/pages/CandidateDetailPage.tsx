...
export default function CandidateDetailPage() {
  ...
  // Get skills from parsed data when database is empty (fallback mechanism)
  const { skills: fallbackSkills, candidateSkills: fallbackCandidateSkills } = 
    useParsedDataFallback ? skillsFromParsed(parsedData?.complete_resume_json?.skills || parsedData?.skills) : { skills: [], candidateSkills: [] }
