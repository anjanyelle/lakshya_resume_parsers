...
export default function CandidateDetailPage() {
  ...
  const experienceData = currentCandidate?.work_experience
    ? calculateTotalExperience(currentCandidate.work_experience)
    : null;
            ...
            <div className="p-6">
              ...
              {activeTab === "overview" && (
                <div className="space-y-6">
                  {currentCandidate.total_years_exp && (
                    <div className="bg-green-50 rounded-xl p-4 border border-green-200 shadow-sm flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xl font-bold text-gray-900">{currentCandidate.total_years_exp.formatted_string || `${currentCandidate.years_experience} Years`}</p>
                        </div>
                      </div>
                    </div>
                  )}
