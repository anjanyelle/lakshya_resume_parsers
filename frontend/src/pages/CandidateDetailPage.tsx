...
export default function CandidateDetailPage() {
  ...
  // Candidate Personal Information - LIGHT GREEN
  { id: 'full_name', value: displayCandidate.full_name ?? '', label: 'Candidate Name', type: 'personal' as const },
  { id: 'email', value: displayCandidate.email ?? '', label: 'Candidate Email', type: 'personal' as const },
  { id: 'phone', value: displayCandidate.phone ?? '', label: 'Candidate Phone', type: 'personal' as const },
  { id: 'location', value: displayCandidate.location ?? '', label: 'Location', type: 'personal' as const },
  { id: 'linkedin_url', value: displayCandidate.linkedin_url ?? '', label: 'LinkedIn', type: 'personal' as const },
  { id: 'github_url', value: displayCandidate.github_url ?? '', label: 'GitHub', type: 'personal' as const },  
  
  // Skills - LIGHT BLUE (only from database)
  ...displaySkills
    .filter((s) => s.name?.trim().length > 2)
    .map((s) => ({ id: 'skills' as const, value: s.name, label: 'Skills', type: 'skills' as const })),
  
  // Work History - LIGHT PURPLE
  ...displayWorkHistory
  ...
  // Common Client/Company Names - LIGHT PURPLE
  { id: 'experience', value: 'e Bay', label: 'Experience', type: 'experience' as const },
  { id: 'experience', value: 'AT & T', label: 'Experience', type: 'experience' as const },
  { id: 'experience', value: 'Honeywell', label: 'Experience', type: 'experience' as const },
  { id: 'experience', value: 'Ramco Systems', label: 'Experience', type: 'experience' as const },
