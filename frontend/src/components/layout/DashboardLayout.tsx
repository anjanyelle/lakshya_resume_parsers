...
export default function DashboardLayout() {
  ...
  const canViewOwnClients = usePermission("clients", "view_own");
  ...
  const navigation: NavItem[] = [
    ...
    ...(user?.role === 'client_manager' && canViewOwnClients ? [{
      name: "Dashboard",
      href: "/client-manager/dashboard",
      icon: (
        <svg
          className="h-5 w-5"
          fill="none"
        ...
        >
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 001 1h3m-6 0a1 1 0 001-1v-4a1 1 0 011-1H2a1 1 0 00-1 1v4a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 001 1h3m-6 0a1 1 0 001-1v-4a1 1 0 011-1H2a1 1 0 00-1 1v4a1 1 0 001 1h3"
          />
        </svg>
      ),
    }] : []),
    ...(user?.role === 'client_manager' && canViewOwnClients ? [{
      ...
      href: "/client-manager/requirements",
      icon: (
        <svg
          className="h-5 w-5"
          fill="none"
    ...
    ...(user?.role === 'client_manager' && canViewOwnClients ? [{
      ...
      href: "/client-manager/submissions",
      icon: (
        <svg
          className="h-5 w-5"
          fill="none"
    ...
    ...(user?.role === 'client_manager' && canViewOwnClients ? [{
      ...
      href: "/client-manager/interviews",
      icon: (
        <svg
          className="h-5 w-5"
          fill="none"
        ...
        icon: (
          ...
          >
            <path
              ...
              strokeLinejoin="round"
              strokeWidth={2}
              d="M3 12l2-2m0 0l7-7 7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 001 1h3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"
            />
          </svg>
        ),
      },
