  ...
  return (
    <div className="border-b border-slate-200 bg-white py-6">
      <div className="mx-auto max-w-5xl px-4">
        <ol className={cn("relative gap-1", visibleSteps.length === 6 ? "grid grid-cols-6" : "grid grid-cols-7")}>
            ...
            return (
              <li key={step.id} className="relative z-10 text-center">
                <button
                  ...
                  className={cn("w-full transition", !isAccessible && "cursor-not-allowed opacity-50")}
                >
                  <span
                    className={cn(
                      "mx-auto mb-2 flex h-7 w-7 items-center justify-center rounded-full border bg-white",
