...
"""
Comprehensive All Resumes Dataset - Updated
Create one complete dataset file with all your resumes including new ones
"""
...
def create_comprehensive_dataset():
    """Create comprehensive dataset with all resumes including new ones"""
    
    print("🎯 Creating Comprehensive All Resumes Dataset - Updated")
    print("=" * 70)
    
    # All resume data including new ones
    resumes_data = [
        {
            "id": 1,
...
Bachelor of Technology                                                                                      2010 - 2014""",
    ...
    with open('comprehensive_all_resumes_dataset_updated.json', 'w', encoding='utf-8') as f:
    ...
    print("✅ Dataset saved to 'comprehensive_all_resumes_dataset_updated.json'")
