#!/usr/bin/env python3
"""
TASK 1 - Generate 200+ NER training samples with single words only
"""
...
def generate_ner_training_simple():
    """Generate 200+ NER training samples with single words only"""
    
    print("🔧 TASK 1 - GENERATING 200+ NER TRAINING SAMPLES (SIMPLE)")
    print("=" * 60)
    
    # Create perfectly aligned training examples (SINGLE WORDS ONLY)
    training_examples = []
    ...
    skill_examples = [
        ...
        ("Created Power BI reports", {"entities": [(9, 16, "SKILL")]}),
        ...
        ("Used Power BI Service", {"entities": [(5, 9, "SKILL"), (10, 17, "SKILL")]}),
    ...
    client_examples = [
        ("CLIENT Home Depot", {"entities": [(7, 16, "COMPANY")]}),
...
if __name__ == "__main__":
    valid_count = generate_ner_training_simple()
