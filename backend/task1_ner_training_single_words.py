#!/usr/bin/env python3
"""
TASK 1 - Generate 200+ NER training samples - SINGLE WORD ENTITIES ONLY
"""
...
def generate_ner_training_single_words():
    """Generate 200+ NER training samples - single word entities only"""
    
    print("🔧 TASK 1 - GENERATING 200+ NER TRAINING SAMPLES (SINGLE WORDS)")
    print("=" * 60)
    
    # Single word training examples ONLY
    training_examples = []
    ...
    skill_examples = [
        ...
        ("Used Redis", {"entities": [(9, 14, "SKILL")]}),
        ("Deployed Docker", {"entities": [(9, 15, "SKILL")]}),
        ("Managed Kubernetes", {"entities": [(8, 19, "SKILL")]}),
        ("Worked with AWS", {"entities": [(12, 15, "SKILL")]}),
        ("Built Azure", {"entities": [(6, 11, "SKILL")]}),
        ("Used GCP", {"entities": [(5, 8, "SKILL")]}),
        ("Wrote Terraform", {"entities": [(6, 15, "SKILL")]}),
        ("Configured Jenkins", {"entities": [(12, 19, "SKILL")]}),
        ("Used Git", {"entities": [(5, 8, "SKILL")]}),
        ("Managed Linux", {"entities": [(8, 13, "SKILL")]}),
        ("Installed Apache", {"entities": [(10, 16, "SKILL")]}),
        ("Configured Nginx", {"entities": [(12, 17, "SKILL")]}),
        ("Used Spark", {"entities": [(5, 10, "SKILL")]}),
        ("Worked with Hadoop", {"entities": [(14, 20, "SKILL")]}),
        ("Used Kafka", {"entities": [(5, 10, "SKILL")]}),
        ("Built Elasticsearch", {"entities": [(6, 19, "SKILL")]}),
        ("Trained TensorFlow", {"entities": [(8, 18, "SKILL")]}),
        ("Used PyTorch", {"entities": [(5, 12, "SKILL")]}),
        ("Applied Scikit", {"entities": [(8, 16, "SKILL")]}),
        ("Analyzed with Pandas", {"entities": [(14, 20, "SKILL")]}),
        ("Computed with NumPy", {"entities": [(13, 17, "SKILL")]}),
        ("Created Power", {"entities": [(9, 14, "SKILL")]}),
        ("Built Tableau", {"entities": [(6, 13, "SKILL")]}),
        ("Used Excel", {"entities": [(5, 10, "SKILL")]}),
        ("Wrote VBA", {"entities": [(6, 9, "SKILL")]}),
        ("Programmed in Python", {"entities": [(13, 19, "SKILL")]}),
        ("Automated with Python", {"entities": [(13, 19, "SKILL")]}),
        ("Used AWS", {"entities": [(5, 8, "SKILL")]}),
        ...
        ("Automated GitHub", {"entities": [(11, 18, "SKILL")]}),
        ("Implemented DevOps", {"entities": [(13, 20, "SKILL")]}),
        ("Built MicroStrategy", {"entities": [(6, 18, "SKILL")]}),
        ("Analyzed with Looker", {"entities": [(14, 20, "SKILL")]}),
        ("Used Power", {"entities": [(5, 9, "SKILL")]}),
        ("Streamed with Beam", {"entities": [(14, 18, "SKILL")]}),
        ("Processed with Spark", {"entities": [(14, 19, "SKILL")]}),
        ("Automated Jenkins", {"entities": [(11, 18, "SKILL")]}),
        ("Managed GitLab", {"entities": [(8, 15, "SKILL")]}),
        ("Used Bitbucket", {"entities": [(6, 15, "SKILL")]}),
        ("Containerized with Docker", {"entities": [(16, 22, "SKILL")]}),
        ("Orchestrated Kubernetes", {"entities": [(14, 26, "SKILL")]}),
        ("Wrote Terraform", {"entities": [(6, 16, "SKILL")]}),
        ("Configured Ansible", {"entities": [(13, 20, "SKILL")]}),
        ("Automated with Puppet", {"entities": [(14, 20, "SKILL")]}),
        ("Used Chef", {"entities": [(6, 10, "SKILL")]}),
        ("Monitored Prometheus", {"entities": [(11, 21, "SKILL")]}),
        ("Built Grafana", {"entities": [(6, 14, "SKILL")]}),
        ("Logged with ELK", {"entities": [(10, 18, "SKILL")]}),
        ("Visualized with Kibana", {"entities": [(14, 21, "SKILL")]}),
        ("Processed with Logstash", {"entities": [(14, 22, "SKILL")]}),
        ("Used React", {"entities": [(5, 11, "SKILL")]}),
        ("Built Angular", {"entities": [(6, 13, "SKILL")]}),
        ("Created Vue", {"entities": [(8, 11, "SKILL")]}),
        ("Used Express", {"entities": [(5, 12, "SKILL")]}),
        ("Applied Spring", {"entities": [(8, 14, "SKILL")]}),
    ]
    
    # TITLE examples (50) - Single/two word titles only
    title_examples = [
    ...
    # COMPANY examples (40) - Single words only
    company_examples = [
...
if __name__ == "__main__":
    valid_count = generate_ner_training_single_words()
