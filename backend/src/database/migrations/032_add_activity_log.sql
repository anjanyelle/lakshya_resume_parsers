...
RAISE NOTICE '🎯 Migration 032_add_activity_log.sql completed successfully';
RAISE NOTICE '📝 Note: Use log_activity() function in controllers to automatically track user activities';