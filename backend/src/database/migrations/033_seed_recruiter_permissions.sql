...
RAISE NOTICE '🎯 Migration 033_seed_recruiter_permissions.sql completed successfully';
RAISE NOTICE '👥 Recruiter role now has appropriate permissions for recruitment activities';