#!/usr/bin/env python3
"""Analyze training dataset for quality issues"""
...
train_file = "ai-service/training/data/simple_dataset_train.conll"
test_file = "ai-service/training/data/simple_dataset_test.conll"
